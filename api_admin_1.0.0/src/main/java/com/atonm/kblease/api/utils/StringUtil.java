...
public final class StringUtil {
	...
	public static int countMatchesCommas(String str) {
	...
	public static String getRandom(Long seed, String type, int loopCount) {
	 ...
	 *
	 * <pre>
	 * StringUtil.commas("1234")  = "1,234"
	 * StringUtils.ommas("123")   = "123"
	 * </pre>
	 *
	 * @param val String 숫자
	 * @return 쉼표형 숫자를 반환
	 */
	public static String commas(String val) {
		try {
			if(StringUtil.isBlank(val))
				return "0";
			return String.format("%,d", new Double(val).longValue());
		} catch(Exception e) {
			return "0";
		}
	}
